    ...
    <main className="prose prose-invert prose-headings:text-zinc-100 prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-xl prose-h2:font-medium prose-p:text-zinc-400 prose-pre:bg-zinc-900  prose-pre:border prose-pre:border-white/10 prose-pre:rounded-2xl prose-a:text-cyan-400">
      <main className="prose prose-invert prose-headings:text-zinc-100 prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-xl prose-h2:font-medium prose-p:text-zinc-400 prose-pre:bg-zinc-900 prose-pre:border prose-pre:border-white/10 prose-pre:rounded-2xl prose-a:text-cyan-400">
        ...
        <p>
          ...
          API requests: Basic authentication and OAuth2 with a token.
        </p>
        ...
        <p>
          ...
          you probably shouldn&#39;t use basic auth. Here&#39;s how to
          authenticate using cURL:
        </p>
        <pre>
          <code className="language-bash">
            curl https://api.protocol.chat/v1/conversations \ -u
            username:password
          </code>
        </pre>
        ...
        <p>
          ...
          OAuth2. When establishing a connection using OAuth2, you will need
          your access token — you will find it in the{" "}
          <a href="#">Protocol dashboard</a> under API settings. Here&#39;s how
          to add the token to the request header using cURL:
        </p>
        <pre>
          <code className="language-bash">
        ...
        <p>
          ...
          library will take care of the rest. All the client libraries use
